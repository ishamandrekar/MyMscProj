...
CODEMASTER = ["transformer_xlnet_base_cased_affinity"]
#"transformer_albert_base_affinity","transformer_bert_base_uncased_affinity",transformer_electra_base_affinity","transformer_roberta_base_affinity","transformer_xlnet_based_cased_affinity"


#"transformer_albert_base_affinity","transformer_albert_large_affinity","transformer_albert_xlarge_affinity","transformer_albert_xxlarge_affinity","transformer_bert_base_uncased_affinity","transformer_bert_large_uncased_affinity","transformer_electra_base_affinity","transformer_electra_large_affinity","transformer_electra_small_affinity","transformer_roberta_base_affinity","transformer_roberta_large_affinity","transformer_xlnet_based_cased_affinity"]
GUESSER = ["transformer_xlnet_base_cased"]
#"transformer_albert_base","transformer_bert_base_uncased","transformer_electra_base","transformer_roberta_base","transformer_xlnet_base_cased"
...
for i in range(len(CODEMASTER)):
    for j in range(len(GUESSER)):
        ...
        for t in range(NUM_EXP): #range(NUM_EXP):#range(14,30):#
