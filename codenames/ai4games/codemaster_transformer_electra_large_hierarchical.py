...
class ai_codemaster(codemaster):
    ...
    def __init__(self, brown_ic=None, glove_vecs=None, word_vectors=None):
        ...
        with torch.no_grad():
            ...
            self.model = ElectraModel.from_pretrained('google/electra-large-generator', output_hidden_states = False,)
            self.model.eval()
        ...
        if 1==1:
            ...
            if len(self.best_combs)==0:
                if len(current_red) != 1:
                    ...
                    red_combs_curr = [] 
                    for unq_item in list(np.unique([elem[0] for elem in curr_best_red_combs])):
