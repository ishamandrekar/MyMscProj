...
class ai_guesser(guesser):
    ...
    def __init__(self, brown_ic=None, glove_vecs=None, word_vectors=None):
        ...
        torch.no_grad()
        self.tokenizer = BertTokenizer.from_pretrained('bert-large-uncased') #RobertaTokenizer.from_pretrained('roberta-base')  
    ...
    def get_clue(self, clue, num):
        ...
        self.clue = clue
        self.num = num
        #to_be_guessed_words = 0
        #if len(self.curGuesses) == 0: #this did not work
            #to_be_guessed_words = num
        #elif len(self.curGuesses) < num:
            #to_be_guessed_words = len(self.curGuesses)
