...
class ai_codemaster(codemaster):
    ...
    def __init__(self, brown_ic=None, glove_vecs=None, word_vectors=None):
        ...
        with torch.no_grad():
            ...
            self.model = AlbertModel.from_pretrained('albert-xxlarge-v2', output_hidden_states = False,)
            self.model.eval()
    ...
    def give_clue(self, game_condition):
        ...
        if 1==1:
            ...
            if len(self.best_combs)!=0: ############## and self.repeat==0:
                print("5")
            ...
            if len(self.best_combs)==0: ################# or self.repeat>0
                print("6")
                if len(current_red) != 1:
