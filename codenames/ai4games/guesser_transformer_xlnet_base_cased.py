...
class ai_guesser(guesser):
    ...
    def __init__(self, brown_ic=None, glove_vecs=None, word_vectors=None):
        ...
        torch.no_grad()
        self.tokenizer = XLNetTokenizer.from_pretrained('xlnet-base-cased') #RobertaTokenizer.from_pretrained('roberta-base')  
        #GPT2Tokenizer.from_pretrained('gpt2')
        # Load pre-trained model (weights)
        self.model = XLNetModel.from_pretrained('xlnet-base-cased') #AutoModelForCausalLM.from_pretrained('gpt2')
