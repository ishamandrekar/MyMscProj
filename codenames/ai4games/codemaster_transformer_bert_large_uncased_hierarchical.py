...
class ai_codemaster(codemaster):
    ...
    def __init__(self, brown_ic=None, glove_vecs=None, word_vectors=None):
        ...
        with torch.no_grad():
            ...
            self.model = BertModel.from_pretrained('bert-large-uncased', output_hidden_states = False,)
            self.model.eval()
        ...
        if 1==1:
            ...
            if len(self.best_combs)==0:
                if len(current_red) != 1:
                    ...
                    map_pos_list = ['r']* len(current_red)  + ['c'] * len(current_blue) + ['b'] * len(current_civil) + ['a'] * 1
