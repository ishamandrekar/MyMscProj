...
class ai_codemaster(codemaster):
    ...
    def __init__(self, brown_ic=None, glove_vecs=None, word_vectors=None):
        ...
        with torch.no_grad():
            ...
            self.model = AlbertModel.from_pretrained('albert-large-v2', output_hidden_states = False,)
            self.model.eval()
        ...
        num_of_neighbours = 10000
        self.knn = NearestNeighbors(n_neighbors=num_of_neighbours)
