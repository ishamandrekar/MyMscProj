...
from transformers import BertTokenizer, RobertaTokenizer, RobertaModel #BertTokenizer, BertModel
...
class ai_guesser(guesser):
    ...
    def __init__(self, brown_ic=None, glove_vecs=None, word_vectors=None):
        ...
        torch.no_grad()
        self.tokenizer = RobertaTokenizer.from_pretrained('roberta-large') #RobertaTokenizer.from_pretrained('roberta-base')  
